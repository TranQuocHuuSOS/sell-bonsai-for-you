    ...
    const handleNav = () => {
        ...
        return (
            <div className='w-full  inline-block'> 
                <div className='shadow-lg  bg-gradient-to-b items-center justify-between from-green-400 to-green-0 w-full w-[100%] h-auto'>
                    ...
                    <div className='flex justify-between items-center mx-1 sm:mx-16 md:mx-28 lg:mx-48 p-8   border-t-[1px] border-gray-300 '>
                        <div>
                            <div className=' md:text-center md:items-center lg:text-center lg:items-center sm:text-center sm:items-center text-center items-center'>
                            ...
                            <div className={nav ? 'w-full bg-green-700 text-white absolute top-[490px]  left-0 flex justify-center text-center' : 'absolute left-[-100%]'}>
                            <ul id="tqd-top-menu" className=' xl:flex hidden sm:gap-2 md:gap-1 lg:gap-4 md:text-center md:items-center lg:text-center lg:items-center sm:text-center sm:items-center text-center items-center'>
                                <li className='tqd-top-menu-item hover:bg-gray-300 p-2 rounded font-normal text-[12px] md:text-[14px] lg:text-[16px]'>
                                    <a href="#">Thảo luận</a>
                                </li>
                ...
                {/* start contennt */}
                <div className='flex px-0 sm:px-12 md:px-20 gap-4 lg:px-36 xl:px-48 p-8 bg-[#f8e8ce]'>
                        ...
                        <div  className='rounded-lg  shadow-sm border-[1px] bg-white my-6'>
                           <div className='flex  justify-between items-center'>
                                <div className='flex  items-center p-4'>
                                        ...
                                        <div className='mx-4'>
                                            <p className='font-medium text-[16px]'>Tran Quoc Huu</p>
                            ...
                            <div className='p-2 xl:mx-16 lg:mx-16 md:mx-12 sm:mx-6 mx-2 grid  grid-cols-3 border-t-[1px]'>
                                <div className='flex items-center'>
                                    ...
                                    <h4  className=' font-semibold text-gray-400 xl:mx-4 lg:mx-4 md:mx-4 sm:mx-4 mx-1'>Thích</h4>
                                </div>
                                <div className='flex items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M168.2 384.9c-15-5.4-31.7-3.1-44.6 6.4c-8.2 6-22.3 14.8-39.4 22.7c5.6-14.7 9.9-31.3 11.3-49.4c1-12.9-3.3-25.7-11.8-35.5C60.4 302.8 48 272 48 240c0-79.5 83.3-160 208-160s208 80.5 208 160s-83.3 160-208 160c-31.6 0-61.3-5.5-87.8-15.1zM26.3 423.8c-1.6 2.7-3.3 5.4-5.1 8.1l-.3 .5c-1.6 2.3-3.2 4.6-4.8 6.9c-3.5 4.7-7.3 9.3-11.3 13.5c-4.6 4.6-5.9 11.4-3.4 17.4c2.5 6 8.3 9.9 14.8 9.9c5.1 0 10.2-.3 15.3-.8l.7-.1c4.4-.5 8.8-1.1 13.2-1.9c.8-.1 1.6-.3 2.4-.5c17.8-3.5 34.9-9.5 50.1-16.1c22.9-10 42.4-21.9 54.3-30.6c31.8 11.5 67 17.9 104.1 17.9c141.4 0 256-93.1 256-208S397.4 32 256 32S0 125.1 0 240c0 45.1 17.7 86.8 47.7 120.9c-1.9 24.5-11.4 46.3-21.4 62.9zM144 272a32 32 0 1 0 0-64 32 32 0 1 0 0 64zm144-32a32 32 0 1 0 -64 0 32 32 0 1 0 64 0zm80 32a32 32 0 1 0 0-64 32 32 0 1 0 0 64z"/></svg>
                                        <h4  className='font-semibold text-gray-400 xl:mx-4 lg:mx-4 md:mx-4 sm:mx-4 mx-1'>Bình luận</h4>
                                </div>
                                <div className='flex items-center'>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 576 512"><path d="M400 255.4V240 208c0-8.8-7.2-16-16-16H352 336 289.5c-50.9 0-93.9 33.5-108.3 79.6c-3.3-9.4-5.2-19.8-5.2-31.6c0-61.9 50.1-112 112-112h48 16 32c8.8 0 16-7.2 16-16V80 64.6L506 160 400 255.4zM336 240h16v48c0 17.7 14.3 32 32 32h3.7c7.9 0 15.5-2.9 21.4-8.2l139-125.1c7.6-6.8 11.9-16.5 11.9-26.7s-4.3-19.9-11.9-26.7L409.9 8.9C403.5 3.2 395.3 0 386.7 0C367.5 0 352 15.5 352 34.7V80H336 304 288c-88.4 0-160 71.6-160 160c0 60.4 34.6 99.1 63.9 120.9c5.9 4.4 11.5 8.1 16.7 11.2c4.4 2.7 8.5 4.9 11.9 6.6c3.4 1.7 6.2 3 8.2 3.9c2.2 1 4.6 1.4 7.1 1.4h2.5c9.8 0 17.8-8 17.8-17.8c0-7.8-5.3-14.7-11.6-19.5l0 0c-.4-.3-.7-.5-1.1-.8c-1.7-1.1-3.4-2.5-5-4.1c-.8-.8-1.7-1.6-2.5-2.6s-1.6-1.9-2.4-2.9c-1.8-2.5-3.5-5.3-5-8.5c-2.6-6-4.3-13.3-4.3-22.4c0-36.1 29.3-65.5 65.5-65.5H304h32zM72 32C32.2 32 0 64.2 0 104V440c0 39.8 32.2 72 72 72H408c39.8 0 72-32.2 72-72V376c0-13.3-10.7-24-24-24s-24 10.7-24 24v64c0 13.3-10.7 24-24 24H72c-13.3 0-24-10.7-24-24V104c0-13.3 10.7-24 24-24h64c13.3 0 24-10.7 24-24s-10.7-24-24-24H72z"/></svg>
                                        <h4  className='font-semibold text-gray-400 xl:mx-4 lg:mx-4 md:mx-4 sm:mx-4 mx-1'>Chia sẻ</h4>
                                </div>
                            </div>
