    ...
    <div className="w-full  inline-block bg-gray-300">
      <div className="mx-48 my-4 h-auto bg-white rounded-lg">
        ...
        <div className="flex gap-8 p-4">
          <div className="font-semibold text-gray-500">Ảnh</div>
          <div className="font-semibold text-gray-500">Video</div>
          <div className="font-semibold text-gray-500">Album</div>
        </div>
        <div className="grid grid-cols-6 gap-2 p-4">
          <video
            class="w-[100px] h-[100px]  autoplay"
            src="9710724946719880 (1).mp4"
            type="video/mp4"
            autoplay
            muted
            loop
