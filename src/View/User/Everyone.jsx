        ...
        <div className='w-full inline-block   bg-gray-300'>
           <div className='mx-0 sm:mx-6 md:mx-20 lg:mx-36 xl:mx-48 my-4 h-auto bg-white rounded-lg'>
            <div className='p-4'>
                ...
                <br/>
                    Người và Trang mới tham gia nhóm này sẽ hiển thị tại đây.<strong> Tìm hiểu thêm</strong>
                <div className='p-4'>
                <input className="border-[1px solid] border-black p-4 font-light text-[16px] flex  bg-gray-200  rounded-[50px] w-full hover:border-gray-500  text-gray-700  " id="password" type="text" placeholder="Tìm kiếm bạn bè..." /> 
                </div>
            </div>
            <div className=' border-t-[1px] mx-2 sm:mx-4 md:mx-4 lg:mx-4 xl:mx-4'>
                <p className='my-4'><strong>Quản trị viên & người kiểm duyệt</strong>· 2</p>
                <div className='flex  items-center justify-between p-4'>
                    ...
                    <button className='   top-2 flex bg-green-500 hover:bg-green-500 items-center rounded bg-primary px-2 sm:px-2 md:px-4 lg:px-6 xl:px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg'>
                        ...
                        <p className='text-black hidden sm:block md:block lg:block hover:text-gray-700 font-bold text-[12px] md:text-[12px] lg:text-[16px] xl:text-[16px]'>Thêm bạn bè</p>
                    </button>
                    </div> 
                </div>
            </div>
            ...
            <div className=' border-t-[1px] mx-4'>
                ...
                <div className='flex  items-center justify-between my-2 p-0 sm:p-4 md:p-4 lg:p-4 xl:p-4'>
                    <div className='flex items-center'>
                       ...
                       <div className=''>
                        <p className=' mx-2 font-medium text-[16px] hover:underline'>Tran Quoc Huu</p>   
                        <p className='hidden md:flex lg:flex xl:flex mx-2'>9 bạn chung bao gồm Dương Thị Hồng Lam và Muas Aster</p>
                        <p className='hidden sm:flex md:flex lg:flex xl:flex mx-2'>Trường PTDT Nội Trú Dăk tô</p>
                       </div>
                    </div>
                    <div className='mx-0 sm:mx-4 md:mx-4 lg:mx-4 xl:mx-4'>
                        <button className='   top-2 flex bg-green-500 hover:bg-green-500 items-center rounded bg-primary px-2 sm:px-2 md:px-4 lg:px-6 xl:px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg'>
