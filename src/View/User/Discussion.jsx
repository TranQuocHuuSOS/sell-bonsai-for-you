                  ...
                  >
                    ...
                    <div className="cursor-pointer flex items-center gap-4 p-2">
                      ...
                      <div className="">
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                          <strong>
                            Tạm ẩn Diệu Nhi Cho Thuê Đăng Kí Duyệt Tự Động trong
                            30 ngày
                          </strong>
                        </p>
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                    ...
                    <div className="cursor-pointer flex items-center gap-4 p-2">
                      ...
                      <div className="">
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                          <strong>
                            {" "}
                            Ẩn tất cả từ Diệu Nhi Cho Thuê Đăng Kí Duyệt Tự Động
                          </strong>
                        </p>
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                    ...
                    <div className="cursor-pointer flex items-center gap-4 p-2">
                      ...
                      <div className="">
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                          <strong> Bỏ theo dõi Hội BONSAI - CÂY CẢNH</strong>
                        </p>
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                    ...
                    <div className="cursor-pointer flex items-center gap-4 p-2">
                      ...
                      <div className="">
                        ...
                        <p className="text-[14px] lg:text-[16px] xl:text-[16px]">
                          Chúng tôi sẽ không cho Diệu Nhi Cho Thuê Đăng Kí Duyệt
                          Tự Động biết ai đã báo cáo.
                        </p>
                      </div>
                    </div>
                  </div>
