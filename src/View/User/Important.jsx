        ...
        <div className="xl:basis-3/5 md:w-full">
          <div className="rounded-lg shadow-sm border-[1px] bg-white">
            <div className="flex p-4">
              <a className="cursor-pointer hidden sm:flex md:flex lg:flex xl:flex ">
                <img
          ...
          <div className="rounded-lg  shadow-sm border-[1px] bg-white my-6">
            <div className="flex  justify-between items-center">
              <div className="flex  items-center p-4">
                ...
                <div className="mx-4">
                  <p className="cursor-pointer font-medium text-[16px]">
                    Diệu nhi cho thuê đăng ký duyệt tự động
                  </p>
                  <span className="cursor-pointer">16 giờ trước</span>
                </div>
              </div>
              <div className="cursor-pointer justify-between mx-4">
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  height="1em"
                  viewBox="0 0 448 512"
            ...
            <div className="my-4  gap-1 items-center justify-center">
              <div className="w-full h-auto bg-[#d512e7] items-center justify-center p-16 font-bold  text-[20px] sm:text-[32px] md:text-[32px] lg:text-[32px] xl:text-[32px]">
                Đăng kí duyệt tự động để bán hàng - Gym bài - Thay banner . IB
                trực tiếp vào page để được hỗ trợ nhé !!!
              </div>
            </div>
            <div className="p-2 xl:mx-16 lg:mx-16 md:mx-12 sm:mx-6 mx-2 grid  grid-cols-3 border-t-[1px]">
              <div className="cursor-pointer grid sm:flex md:flex lg:flex xl:flex items-center justify-center">
                <svg
                ...
                <h4 className="inline-flex items-center justify-center  sm:block md:block lg:block xl:block font-semibold text-gray-400 xl:mx-4 lg:mx-4 md:mx-4 sm:mx-4 mx-1">
                  Thích
                </h4>
              </div>
              <div className="cursor-pointer grid sm:flex md:flex lg:flex xl:flex items-center justify-center">
                ...
                <h4 className="inline-flex items-center justify-center font-semibold text-gray-400 xl:mx-4 lg:mx-4 md:mx-4 sm:mx-4 mx-1">
                  Bình luận
                </h4>
              </div>
              <div className="cursor-pointer grid sm:flex md:flex lg:flex xl:flex items-center justify-center">
            ...
            <div className="flex items-center justify-center my-4 p-4 mx-1 sm:mx-4 md:mx-4 lg:mx-4 xl:mx-4 border-t-[1px]">
              <a className="hidden md:flex lg:flex xl:flex">
                <img
                  className="cursor-pointer rounded-full xl:w-[60px] xl:h-[50px] lg:w-[60px] lg:h-[50px]  md:w-[60px] md:h-[50px] sm:w-[60px] sm:h-[50px] w-[60px] h-[50px]"
                  src="https://bcolohouse.com.vn/wp-content/uploads/2022/04/trong-cay-bonsai-mini-1.jpg"
                  alt=""
                ></img>
              </a>
