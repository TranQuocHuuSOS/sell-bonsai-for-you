             ...
             <div className='mx-0 sm:mx-16 md:mx-32 lg:mx-56 xl:mx-72 my-4 h-auto bg-white rounded-lg'>
                <div className='grid sm:flex md:flex lg:flex xl:flex items-center justify-center sm:justify-between md:justify-between lg:justify-between xl:justify-between p-4 '>
                    ...
                    <div className=' grid sm:flex md:flex lg:flex xl:flex gap-2 items-center justify-center py-2'>
                        ...
                        <dialog id="my_modal_3" className="modal w-[100%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] rounded-xl">
                            <form method="dialog" className="modal-box">
                                <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                                    ...
                                    <p className='flex items-center justify-center text-center'>Không có sự kiện nào sắp diễn ra.</p>
                        ...
                        <button className="bg-green-700 shadow hover:bg-green-500  text-[16px] text-white font-bold py-2 px-0 sm:px-4 md:px-4 lg:px-4 xl:px-4 h-[40px] w-[120px] rounded focus:outline-none focus:shadow-outline" onClick={()=>window.my_modal_2.showModal()} type="button">
                          ...
                          {/* You can open the modal using ID.showModal() method */}
                          <dialog id="my_modal_2" className="modal w-[100%] sm:w-[80%] md:w-[70%] lg:w-[60%] xl:w-[50%] rounded-xl h-[500px]">
                            <form method="dialog" className="modal">
                                <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2 ">✕</button>
                                    ...
                                    <div className='w-auto'>
                                        <input className='hover:bg-gray-300 hover:text-black mx-4 py-4 w-[92%] sm:w-[96%] md:w-[96%] lg:w-[96%] xl:w-[96%] border-black border-[1px] rounded-md' placeholder='Tên sự kiện'>
                                        </input>
                                    </div>
                                    ...
                                    <textarea className='hover:bg-gray-300 p-4 mx-4 w-[92%] sm:w-[96%] md:w-[96%] lg:w-[96%] xl:w-[96%] border-black border-[1px] rounded-md' placeholder='Hãy mô tả chi tiết về sự kiện'>
                    ...
                    <div className='grid sm:flex md:flex lg:flex xl:flex my-4 border-b-[1px]'>
                        ...
                        <div className='mx-4'>
                            ...
                            <div className='flex'>
                                ...
                                <div className={nav ? 'rounded-lg  mx-[1%] p-2  sm:mx-[12%] md:mx-[20%] lg:mx-[25%] xl:w-[400px] lg:w-[400px] md:w-[400px] sm:w-[400px] w-[250px] absolute shadow-lg bg-green-200 text-black md:top-[700px] xl:top-[1150px] lg:top-[1200px] sm:top-[600px] left-0  justify-center ' : 'absolute left-[-400%] sm:left-[-200%] md:left-[-100%] lg:left-[-100%] xl:left-[-100%]'}>
