    ...
    return (
        ...
        <div className='lg:flex md:flex sm:block block justify-between  sm:px-16 md:px-24 lg:px-48 py-4 sm:py-4 md:py-6 lg:py-8 xl:py-8 px-8'>
            ...
            <div className='flex items-center justify-center gap-2 md:gap-4 lg:gap-4'>
                ...
                <dialog id="my_modal_invite" className="modal w-[100%] sm:w-[95%] md:w-[90%] lg:w-[90%] xl:w-[90%] rounded-xl">
                    <form method="dialog" className="modal-box">
                        <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                            <h3 className="flex font-bold text-lg border-b-[1px] p-6 justify-center items-center text-[14px] sm:text-[18px] md:text-[18px] lg:text-[18px] xl:text-[18px]">Mời bạn bè tham gia nhóm này</h3>
                            ...
                            <div className='flex border-b-[2px] '>
                                <div className='basis-full lg:basis-3/4 xl:basis-3/4  p-4 items-center justify-center '>
                                    <div className='sm:flex md:flex lg:flex xl:flex gap-4 sm:gap-2 md:gap-2 lg:gap-2 xl:gap-2'>
                                        <button className="flex items-center justify-center md:justify-start lg:justify-start xl:justify-start gap-2 bg-gray-300 shadow hover:bg-gray-400 text-[16px] text-black font-bold py-2 px-4 h-[40px] w-full rounded focus:outline-none focus:shadow-outline" type="button">
                                            <img class="x1b0d499 xi3auck" src="https://static.xx.fbcdn.net/rsrc.php/v3/yC/r/Z0Ov3P_7mJZ.png" alt="" height="20" width="20"></img>
                                            Đà Nẵng      
                                        </button>
                                        <button className="my-2 sm:my-0 md:my-0 lg:my-0 xl:my-0 flex items-center justify-center md:justify-start lg:justify-start xl:justify-start gap-2 bg-gray-300 shadow hover:bg-gray-400 text-[16px] text-black font-bold py-2 px-4 h-[40px] w-full rounded focus:outline-none focus:shadow-outline" type="button">
                                    ...
                                    <div className='max-h-[200px] overflow-y-scroll'>
                                        <div className='flex items-center justify-between py-2 mx-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className=''>
                                                    <p className='mx-2 font-medium text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] hover:underline'>Nguyễn Trọng Nam</p>   
                                                    <p className='hidden sm:flex md:flex lg:flex xl:flex mx-2 max-w-md'>9 bạn chung bao gồm Dương Thị Hồng Lam và Muas Aster</p>
                                                </div>
                                            </div>
                                        ...
                                        <div className='flex items-center justify-between py-2 mx-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className=''>
                                                    <p className=' mx-2 font-medium text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] hover:underline'>Tran Quoc Huu</p>   
                                                    <p className=' mx-2 hidden sm:flex md:flex lg:flex xl:flex max-w-md'>9 bạn chung bao gồm Dương Thị Hồng Lam và Muas Aster</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-center mb-4">
                                                <input
                                        ...
                                        <div className='flex items-center justify-between py-2 mx-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className=''>
                                                    <p className=' mx-2 font-medium text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] hover:underline'>Tran Quoc Toản</p>   
                                                    <p className=' mx-2 hidden sm:flex md:flex lg:flex xl:flex max-w-md'>9 bạn chung bao gồm Dương Thị Hồng Lam và Muas Aster</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-center mb-4">
                                        ...
                                        <div className='flex items-center justify-between py-2 mx-4'>
                                            <div className='flex items-center'>
                                                ...
                                                <div className=''>
                                                    <p className=' mx-2 font-medium text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] hover:underline'>Tran Quoc Tuấn</p>   
                                                    <p className=' mx-2 hidden sm:flex md:flex lg:flex xl:flex max-w-md'>9 bạn chung bao gồm Dương Thị Hồng Lam và Muas Aster</p>
                                                </div>
                                            </div>
                                            <div className="flex items-center justify-center mb-4">
                            ...
                            <div className='flex gap-2 p-4 '>
                                    ...
                                    <div className='flex items-center justify-center gap-2 w-full'>
                                        <button className=" inline-block gap-2 bg-gray-300 shadow hover:bg-gray-400 text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] text-black font-bold py-2 px-4 h-[40px] w-full rounded focus:outline-none focus:shadow-outline"  type="button">           
                                            Hủy      
                                        </button>
                                        <button className=" gap-2 inline-block bg-gray-300 shadow hover:bg-gray-400 text-[12px] sm:text-[16px] md:text-[16px] lg:text-[16px] xl:text-[16px] text-black font-bold py-2 px-4 h-[40px] w-[100%] rounded focus:outline-none focus:shadow-outline"  type="button">
                                            Gửi lời mời    
                                        </button>
                                    </div>
            ...
            <ul className="border-[1px] top-[10%] p-2 bg-white w-[100%] shadow-xl menu dropdown-content bg-base-100 rounded-md ">
                <div className='container'>
                    <div className='grid sm:flex md:flex lg:flex xl:flex items-center justify-center sm:justify-between md:justify-between lg:justify-between xl:justify-between'>
                        <p className='flex justify-center sm:justify-start md:justify-start lg:justify-start xl:justify-start'>Nhóm liên quan</p>
                        <p className='text-blue-700 flex justify-center sm:justify-end md:justify-end lg:justify-end xl:justify-end'>Khám phá các nhóm khác</p>
                    </div>
                    <div className='grid-cols-1 sm:grid-cols-2 grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-3 gap-4 p-0 sm:p-2 md:p-4 lg:p-4 xl:p-4 '>
                        <div className='rounded-lg shadow-xl border-[1px] '>
                            ...
                            <div className='p-4'>
                                <p className='text-[16px] sm:text-[18px] md:text-[20px] lg:text-[20px] xl:text-[20px] hover:underline'><strong>Hội buôn bán giao lưu trầm</strong></p>
                                <p className='sm:text-[16px] md:text-[18px] lg:text-[18px] xl:text-[18px]'>117K thành viên • Hơn 10 bài viết/ngày</p>
                                <div className='flex items-center '>
                            ...
                            <div className='p-4'>
                                <button className=' justify-center  top-2 flex w-full bg-blue-500 hover:bg-blue-700 items-center rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight text-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg'>
                                    <svg xmlns="http://www.w3.org/2000/svg" stroke="currentColor" height="1rem" viewBox="0 0 576 512"><path d="M112 48a48 48 0 1 1 96 0 48 48 0 1 1 -96 0zm40 304V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V256.9L59.4 304.5c-9.1 15.1-28.8 20-43.9 10.9s-20-28.8-10.9-43.9l58.3-97c17.4-28.9 48.6-46.6 82.3-46.6h29.7c33.7 0 64.9 17.7 82.3 46.6l44.9 74.7c-16.1 17.6-28.6 38.5-36.6 61.5c-1.9-1.8-3.5-3.9-4.9-6.3L232 256.9V480c0 17.7-14.3 32-32 32s-32-14.3-32-32V352H152zM432 224a144 144 0 1 1 0 288 144 144 0 1 1 0-288zm16 80c0-8.8-7.2-16-16-16s-16 7.2-16 16v48H368c-8.8 0-16 7.2-16 16s7.2 16 16 16h48v48c0 8.8 7.2 16 16 16s16-7.2 16-16V384h48c8.8 0 16-7.2 16-16s-7.2-16-16-16H448V304z"/></svg>
                                    <p className='text-black hidden sm:block md:block lg:block xl:block hover:text-gray-700 font-bold text-[12px] sm:text-[12px] md:text-[12px] lg:text-[14px] xl:text-[16px]'>Tham gia nhóm</p>
                                </button>
                            </div> 
                        </div>
                        ...
                        <div className='rounded-lg shadow-xl border-[1px]'>
                            ...
                            <div className='p-4'>
                                <p className='text-[16px] sm:text-[18px] md:text-[20px] lg:text-[20px] xl:text-[20px] hover:underline'><strong>Hội Cây Cảnh Việt Nam</strong></p>
                                <p className='sm:text-[16px] md:text-[18px] lg:text-[18px] xl:text-[18px]'>48K thành viên • 8 bài viết/ngày</p>
                                <div className='flex items-center '>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M57.7 193l9.4 16.4c8.3 14.5 21.9 25.2 38 29.8L163 255.7c17.2 4.9 29 20.6 29 38.5v39.9c0 11 6.2 21 16 25.9s16 14.9 16 25.9v39c0 15.6 14.9 26.9 29.9 22.6c16.1-4.6 28.6-17.5 32.7-33.8l2.8-11.2c4.2-16.9 15.2-31.4 30.3-40l8.1-4.6c15-8.5 24.2-24.5 24.2-41.7v-8.3c0-12.7-5.1-24.9-14.1-33.9l-3.9-3.9c-9-9-21.2-14.1-33.9-14.1H257c-11.1 0-22.1-2.9-31.8-8.4l-34.5-19.7c-4.3-2.5-7.6-6.5-9.2-11.2c-3.2-9.6 1.1-20 10.2-24.5l5.9-3c6.6-3.3 14.3-3.9 21.3-1.5l23.2 7.7c8.2 2.7 17.2-.4 21.9-7.5c4.7-7 4.2-16.3-1.2-22.8l-13.6-16.3c-10-12-9.9-29.5 .3-41.3l15.7-18.3c8.8-10.3 10.2-25 3.5-36.7l-2.4-4.2c-3.5-.2-6.9-.3-10.4-.3C163.1 48 84.4 108.9 57.7 193zM464 256c0-36.8-9.6-71.4-26.4-101.5L412 164.8c-15.7 6.3-23.8 23.8-18.5 39.8l16.9 50.7c3.5 10.4 12 18.3 22.6 20.9l29.1 7.3c1.2-9 1.8-18.2 1.8-27.5zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg>
                                    <h4  className=' mx-2'>Công khai</h4>
                                </div>
                        ...
                        <div className='rounded-lg shadow-xl border-[1px]'>
                            ...
                            <div className='p-4'>
                                <p className='text-[16px] sm:text-[18px] md:text-[20px] lg:text-[20px] xl:text-[20px] hover:underline'><strong>Giao lưu Bonsai</strong></p>
                                <p className='sm:text-[16px] md:text-[18px] lg:text-[18px] xl:text-[18px]'>12K thành viên • 10 bài viết/tuần</p>
                                <div className='flex items-center '>
                                    <svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 512 512"><path d="M57.7 193l9.4 16.4c8.3 14.5 21.9 25.2 38 29.8L163 255.7c17.2 4.9 29 20.6 29 38.5v39.9c0 11 6.2 21 16 25.9s16 14.9 16 25.9v39c0 15.6 14.9 26.9 29.9 22.6c16.1-4.6 28.6-17.5 32.7-33.8l2.8-11.2c4.2-16.9 15.2-31.4 30.3-40l8.1-4.6c15-8.5 24.2-24.5 24.2-41.7v-8.3c0-12.7-5.1-24.9-14.1-33.9l-3.9-3.9c-9-9-21.2-14.1-33.9-14.1H257c-11.1 0-22.1-2.9-31.8-8.4l-34.5-19.7c-4.3-2.5-7.6-6.5-9.2-11.2c-3.2-9.6 1.1-20 10.2-24.5l5.9-3c6.6-3.3 14.3-3.9 21.3-1.5l23.2 7.7c8.2 2.7 17.2-.4 21.9-7.5c4.7-7 4.2-16.3-1.2-22.8l-13.6-16.3c-10-12-9.9-29.5 .3-41.3l15.7-18.3c8.8-10.3 10.2-25 3.5-36.7l-2.4-4.2c-3.5-.2-6.9-.3-10.4-.3C163.1 48 84.4 108.9 57.7 193zM464 256c0-36.8-9.6-71.4-26.4-101.5L412 164.8c-15.7 6.3-23.8 23.8-18.5 39.8l16.9 50.7c3.5 10.4 12 18.3 22.6 20.9l29.1 7.3c1.2-9 1.8-18.2 1.8-27.5zM0 256a256 256 0 1 1 512 0A256 256 0 1 1 0 256z"/></svg>
                                    <h4  className=' mx-2'>Công khai</h4>
                                </div>
        ...
        <div className='flex justify-between items-center mx-1 sm:mx-16 md:mx-28 lg:mx-48 py-4 sm:py-4 md:py-6 lg:py-8 xl:py-8 px-8   border-t-[1px] border-gray-300 '>
                ...
                <div className='xl:flex  hidden md:text-center md:items-center lg:text-center lg:items-center sm:text-center sm:items-center text-center items-center'>
                    <ul id="tqd-top-menu" className='tabs xl:flex  hidden sm:gap-2 md:gap-1 lg:gap-4 md:text-center md:items-center lg:text-center lg:items-center sm:text-center sm:items-center text-center items-center'>
                        <li className=' tab-item  tqd-top-menu-item hover:bg-gray-300 p-2 rounded font-normal text-[12px] md:text-[14px] lg:text-[16px]'>
                            <Link className='tab-icon fas fa-code' to="/Home">Thảo luận</Link>
                        </li>
                        <li className='tab-item  tqd-top-menu-item hover:bg-gray-300 p-2 rounded font-normal text-[12px] md:text-[14px] lg:text-[16px]'>
            ...
            {/*Bắt đầu modal search */}
                <dialog id="my_modal_search" className="modal w-[100%] sm:w-[80%] md:w-[60%] lg:w-[50%] xl:w-[50%] rounded-xl">
                    <form method="dialog" className="modal-box">
                        <button className="btn btn-sm btn-circle btn-ghost absolute right-2 top-2">✕</button>
                    ...
                    <summary  className=" flex hover:bg-gray-300  top-2  items-center rounded bg-primary px-6 py-2.5 text-xs font-medium uppercase leading-tight bg-white shadow-md transition duration-150 ease-in-out hover:bg-primary-700 hover:shadow-lg focus:bg-primary-700 focus:shadow-lg focus:outline-none focus:ring-0 active:bg-primary-800 active:shadow-lg h-[30px] sm:h-[40px] md:h-[40px] lg:h-[40px] xl:h-[40px]"><svg xmlns="http://www.w3.org/2000/svg" height="1em" viewBox="0 0 448 512"><path d="M8 256a56 56 0 1 1 112 0A56 56 0 1 1 8 256zm160 0a56 56 0 1 1 112 0 56 56 0 1 1 -112 0zm216-56a56 56 0 1 1 0 112 56 56 0 1 1 0-112z"/></svg></summary>
                        <ul className="mx-4 right-[2px] sm:right-[10px] md:right-[10px] lg:right-[10px] xl:right-[10px] p-2 absolute menu dropdown-content z-[1] bg-base-100 rounded-box shadow-lg bg-green-200 text-black">
                            <div className='flex items-center gap-4 p-2'>
                                ...
                                />
                                <div className=''> 
                                    <p className='text-[14px] lg:text-[16px] xl:text-[16px]'><strong>Nội dung của bạn</strong></p>                      
                                </div>
                            </div>
                            <div className='flex items-center gap-4 p-2   '>
                                ...
                                <div className=''> 
                                    <p className='text-[14px] lg:text-[16px] xl:text-[16px]'><strong>Chia sẻ</strong></p>
                                </div>
                            </div>
                            <div className='flex items-center gap-4 p-2'>
                                ...
                                />
                                <div className=''> 
                                    <p className='text-[14px] lg:text-[16px] xl:text-[16px]'><strong>Ghim nhóm</strong></p>
                                </div>
                            </div>
                            <div className='flex items-center gap-4 p-2'>
                                <i data-visualcompletion="css-img"className="x1b0d499 xep6ejk"
                                ...
                                />
                                <div className=''> 
                                    <p className='text-[14px] lg:text-[16px] xl:text-[16px]'><strong>Sắp xếp bình luận</strong></p>
                                </div>
                            </div>
                            <div className='flex items-center gap-4 p-2'>
                                <i data-visualcompletion="css-img"className="x1b0d499 xep6ejk"
                                ...
                                />
                                <div className=''> 
                                    <p className='text-[14px] lg:text-[16px] xl:text-[16px]'><strong>Báo cáo nhóm</strong></p>
                                </div>
                            </div>
                        </ul>
                </details>
