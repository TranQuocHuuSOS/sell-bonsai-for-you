            ...
            <header className='fixed w-full bg-white'>
                <div className=' grid sm:flex md:flex lg:flex xl:flex Navbar items-center p-2 md:p-4 lg:p-6 xl:p-6 justify-center sm:justify-between md:justify-between lg:justify-between xl:justify-between'>
                    ...
                    <div className="flex items-center justify-center sm:justify-end md:justify-end lg:justify-end xl:justify-end  w-full lg:max-w-[800vw] xl:max-w-[800vw] ">
                        <form className="bg-white flex items-center sm:justify-end md:justify-end lg:justify-end xl:justify-end lg:gap-2 w-full rounded ">
                            <div className="">
                            ...
                            <div className="flex items-center lg:gap-2 justify-between gap-2">
                                ...
                                <button className="flex items-center justify-center sm:justify-end md:justify-end lg:justify-end xl:justify-end   lg:hidden xl:hidden bg-green-700 shadow hover:bg-green-500  text-[16px] text-white font-bold py-2 px-4 h-[40px] w-[100px] rounded focus:outline-none focus:shadow-outline" type="button">
