    ...
    <header className="fixed w-full bg-white">
      <div className=" grid sm:flex md:flex lg:flex xl:flex Navbar items-center p-2 md:p-4 lg:p-6 xl:p-6 justify-center sm:justify-between md:justify-between lg:justify-between xl:justify-between">
        <div className="name-web">
          <Link
            to="/"
            className="Home text-green-700 font-extrabold text-[20px] md:text-[30px] lg:text-[30px] hover:text-green-500 flex justify-center sm:justify-start md:justify-start lg:justify-start xl:justify-start"
          >
            FloraTradeNetwork
          </Link>
        </div>
